...
with open('/home/mpa/Desktop/data_analysis/city-trees.json', 'r') as f:
...
property_data = pd.read_csv('/home/mpa/Desktop/data_analysis//property-data.csv', encoding='latin1')
